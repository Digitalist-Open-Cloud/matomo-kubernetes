...
class FieldAvgHesitationTime extends ProcessedMetric
{
    public function getName()
    {
        return PluginMetrics::AVG_FIELD_HESITATION_TIME;
    }

    public function getTranslatedName()
    {
        return Piwik::translate('FormAnalytics_ColumnAvgHesitationTime');
    }

    public function compute(Row $row)
    {
        $hesitationTime = $this->getMetric($row, PluginMetrics::SUM_FIELD_HESITATION_TIME);
    ...
    {
        return array(PluginMetrics::SUM_FIELD_HESITATION_TIME, PluginMetrics::SUM_FIELD_UNIQUE_INTERACTIONS);
    }
