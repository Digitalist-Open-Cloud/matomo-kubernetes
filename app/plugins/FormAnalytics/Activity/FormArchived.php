...
class FormArchived extends BaseActivity
{
    protected $eventName = 'API.FormAnalytics.archiveForm.end';
    ...
    public function getTranslatedDescription($activityData, $performingUser)
    {
        ...
        $desc = sprintf('archived the form "%1$s" for site "%2$s"', $formName, $siteName);
