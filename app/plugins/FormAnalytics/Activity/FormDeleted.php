...
class FormDeleted extends BaseActivity
{
    protected $eventName = 'API.FormAnalytics.deleteForm.end';
    ...
    public function getTranslatedDescription($activityData, $performingUser)
    {
        ...
        $desc = sprintf('deleted the form "%1$s" for site "%2$s"', $formName, $siteName);
