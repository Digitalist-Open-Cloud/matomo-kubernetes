...
class ReportUpdated extends BaseActivity
{
    protected $eventName = 'API.CustomReports.updateCustomReport.end';

    public function extractParams($eventData)
    {
        list($return, $finalAPIParameters) = $eventData;

        $idCustomReport = $finalAPIParameters['parameters']['idCustomReport'];
    ...
    public function getTranslatedDescription($activityData, $performingUser)
    {
        ...
        $desc = sprintf('updated the report "%1$s" for site "%2$s"', $reportName, $siteName);
