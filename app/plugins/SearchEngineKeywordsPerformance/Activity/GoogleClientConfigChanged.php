...
class GoogleClientConfigChanged extends Activity
{
    protected $eventName = 'SearchEngineKeywordsPerformance.GoogleClientConfigChanged';
    ...
    {
        return Piwik::translate('SearchEngineKeywordsPerformance_ActivityGoogleClientConfigChanged');
    }
}