...
class AccountAdded extends Activity
{
    protected $eventName = 'SearchEngineKeywordsPerformance.AccountAdded';
    ...
    {
        return Piwik::translate('SearchEngineKeywordsPerformance_ActivityAccountAdded',
