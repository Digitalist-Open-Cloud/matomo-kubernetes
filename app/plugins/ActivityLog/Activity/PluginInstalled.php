...
class PluginInstalled extends Activity
{
    protected $eventName = 'PluginManager.pluginInstalled';
    ...
    public function getPerformingUser($eventData = null)
    {
        ...
        if ($login === self::USER_ANONYMOUS) {
            // anonymous cannot deactivate a plugin. The system may install plugins before access is initialized
    ...
    {
        return Piwik::translate('ActivityLog_PluginInstalled');
    }
}