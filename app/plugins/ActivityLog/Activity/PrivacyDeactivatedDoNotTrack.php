...
class PrivacyDeactivatedDoNotTrack extends Activity
{
    protected $eventName = 'API.PrivacyManager.deactivateDoNotTrack.end';
    ...
    {
        return Piwik::translate('ActivityLog_PrivacyDeactivatedDoNotTrack');
    }
}