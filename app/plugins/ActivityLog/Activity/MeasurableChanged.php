...
class MeasurableChanged extends Activity
{
    protected $eventName = 'API.SitesManager.updateSite.end';
    ...
    public function extractParams($eventData)
    {
        ...
        // $finalAPIParameters[parameters] = [ idSite, siteName, urls, ecommerce, siteSearch, searchKeywordParameters,
        ...
        $site = new Site($finalAPIParameters['parameters']['idSite']);
            ...
            'items' => [
                [
                    ...
                    'data' => [
                        ...
                        'type' => $site->getType(),
                        'name' => $site->getName(),
                        'urls' => SitesManagerAPI::getInstance()->getSiteUrlsFromId($site->getId())
                    ]
                ]
            ],
        ];
    ...
    {
        return Piwik::translate('ActivityLog_MeasurableChanged');
    }
}